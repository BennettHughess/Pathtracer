...
``` 
2. Navigate to the repository (important). Open the Makefile and configure the `CXX` variable so that the correct compiler is used; the default is `clang++`. Run `make`.
```console
